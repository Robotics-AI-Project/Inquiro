...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-md py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[state=checked]:bg-secondary data-[state=checked]:fill-secondary-foreground data-[state=checked]:text-secondary-foreground data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
